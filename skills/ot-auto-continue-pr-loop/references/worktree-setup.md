...
Detailed procedure for step 4 (create) and step 11 (cleanup) of `ot-auto-continue-pr-loop`. Never resume in the user's primary worktree.
...
WORKTREE_PARENT="$REPO_ROOT/.ai/tmp/ot-auto-continue-pr-loop"
CREATED_WORKTREE=0
