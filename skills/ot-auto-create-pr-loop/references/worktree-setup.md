...
Detailed procedure for step 6 (create) and step 14 (cleanup) of `ot-auto-create-pr-loop`. Never run in the user's primary worktree.
...
WORKTREE_PARENT="$REPO_ROOT/.ai/tmp/ot-auto-create-pr-loop"
CREATED_WORKTREE=0
