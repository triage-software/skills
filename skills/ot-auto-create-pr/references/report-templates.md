...
```markdown
{✅ or 🔁 or ⛔} `ot-auto-create-pr`: {what changed; ready, incomplete or blocked, and why.}
...
{Next review/QA decision, or first remaining Step and `ot-auto-continue-pr {prNumber}`.}
```
...
On a fresh `ot-auto-create-pr` run, include the routing line from
