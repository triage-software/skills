...
Detailed procedure for step 5 (create) and step 12 (cleanup) of `ot-auto-fix-issue`. Never run in the user's primary worktree.
...
WORKTREE_PARENT="$REPO_ROOT/.ai/tmp/ot-auto-fix-issue"
CREATED_WORKTREE=0
...
- This procedure applies to the bug route only; on the feature route the delegated skills (`ot-auto-write-spec`, `ot-auto-implement-spec`) own their own worktrees.
