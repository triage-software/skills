...
outstanding review findings** — `ot-auto-review-pr --autofix` owns both, in that
...
required checks: the hand-off to `ot-approve-merge-pr` says what CI actually did, and
