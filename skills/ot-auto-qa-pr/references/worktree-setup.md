...
Detailed procedure for the check-out and cleanup steps of `ot-auto-qa-pr` (PR mode). Never verify in the user's primary worktree.
...
WORKTREE_PARENT="$REPO_ROOT/.ai/tmp/ot-auto-qa-pr"
CREATED_WORKTREE=0
