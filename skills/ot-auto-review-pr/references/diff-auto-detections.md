...
The severity-tagged pattern tables the `ot-auto-review-pr` body scans the PR diff
against in step 7, before running the full `ot-code-review` skill. When a pattern
