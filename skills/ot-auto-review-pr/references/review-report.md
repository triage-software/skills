# Review and report — the ot-code-review pass plus the autofix loop

Detailed procedure for step 8 (full review pass) and step 11 (autonomous autofix and fix-forward loop) of `ot-auto-review-pr`. This skill is itself the automated second pass that other skills in this collection invoke; the review engine underneath is always the `ot-code-review` skill, executed verbatim inside the isolated worktree.

## Review pass (step 8)

Use the `ot-code-review` skill against the PR diff. Explicitly verify:
...
## ot-auto-review-pr specifics — pass scope and gates (step 8)
...
## ot-auto-review-pr specifics — autonomous autofix flow (step 11)
...
## ot-auto-review-pr specifics — fix-forward loop (step 11)
