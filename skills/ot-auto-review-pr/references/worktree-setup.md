...
Detailed procedure for step 5 (create) and step 12 (cleanup) of `ot-auto-review-pr`. Never review directly in the repository's primary worktree.
...
WORKTREE_PARENT="$REPO_ROOT/.ai/tmp/ot-auto-review-pr"
CREATED_WORKTREE=0
