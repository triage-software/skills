...
0. **Agentic setup** — follow `references/agentic-setup.md`: load the repo's
   ...
   `ot-filozofia.md` — the layering philosophy, the agent instruction files)
