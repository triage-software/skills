...
`ot-create-skill` opens no PRs itself. This file is this skill's own copy of the
label-normalization contract from the canonical PR-finalize procedure of the
pipeline's PR-opening skills (`ot-open-pr` and the PR-driving `ot-auto-*`
