...
Full procedure for the generation phase of `ot-prepare-test-env`, steps 2.1–2.6,
...
1. If the provider was explicit and `$BROWSER_FILE` is missing, run
   `ot-setup-agent-pipeline` to install the selected descriptor, reload, and
...
1. Record **why** in the repo-local skill (`.ai/skills/ot-prepare-test-env/SKILL.md`),
